...
function NavBar() {
  ...
  return (
    <div className='border-b-[0.5px] border-gray-600 flex justify-center'>
        <div className='w-full max-w-[1600px] flex items-center justify-between p-3 px-10'>
          <div><a href='/' className='font-serif'>NoteShare</a></div>
          <div>
          {session ? (
